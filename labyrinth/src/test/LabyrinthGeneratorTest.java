...
public class LabyrinthGeneratorTest {
	...
	public static void testdig(LabyrinthGenerator lg) throws Exception {
		...
		Cell next = lg.dig(lg.getLabyrinth().getCells().get(4), Cell.NORTH, lg.getPath());
		...
		Cell next2 = lg.dig(lg.getLabyrinth().getCells().get(8), Cell.EAST,lg.getPath());
		...
		Cell next3 = lg.dig(lg.getLabyrinth().getCells().get(2), Cell.WEST,lg.getPath());
